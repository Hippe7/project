    ...
    <script type="text/javascript">
        function deleteEnt(id) {
            if(confirm('确实要删除该客户吗?')) {
                $.post("${pageContext.request.contextPath}/admin/deleteEnt",{id:id},
                    function(data){
                        if(data ==="OK"){
                            alert("删除成功！");
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/admin/entLoad" class="active-menu"><i class="fa fa-edit"></i>企业信息管理</a>
                </li>
                <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables">
                                    ...
                                    <tbody>
                                    <c:forEach items="${sessionScope.enterpriseList}" var="row" varStatus="status">
                                        <tr>
                                            <td>${row.id}</td>
                                            <td>${row.loginName}</td>
                                            <td>${row.password}</td>
                                            ...
                                            <td>${row.address}</td>
                                            <td>
                                                <input type="button" class="btn btn-primary btn-xs" onclick="deleteEnt('${row.id}')" value="删除"/>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
