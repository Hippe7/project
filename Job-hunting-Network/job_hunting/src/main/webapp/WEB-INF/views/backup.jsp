        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href="stuInfo.action"><i class="fa fa-user fa-fw"></i> 毕业生信息管理</a></li>
                    <li><a href="entAppInfo.action"><i class="fa fa-user fa-fw"></i> 企业招聘管理</a></li>
                    <li><a href="${pageContext.request.contextPath}/admin/jobLoad"><i class="fa fa-gear fa-fw"></i> 数据统计</a></li>
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="${pageContext.request.contextPath}/admin/backup.action"><i class="fa fa-bar-chart-o"></i>数据备份</a>
                </li>
            </ul>
...
<script>
    ...
    function backup() {
        $.get("${pageContext.request.contextPath}/admin/bbackup.action",function(data){
            if(data==="OK"){
                alert("备份成功！");
            }else{
                alert("备份失败！");
    ...
    function rebackup() {
        ...
        $.get("${pageContext.request.contextPath}/admin/rebackup.action", {"mess":mess},function(data){
            if(data==="OK"){
                alert("恢复成功！");
            }else{
                alert("恢复失败！");
