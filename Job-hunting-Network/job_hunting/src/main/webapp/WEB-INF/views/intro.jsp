...
<head>
    ...
    <script type="text/javascript">
        function sub() {
            ...
            var s_native=$("#passport").find("option:selected").val();
            var idcard = $("#passportid").val();
            ...
            var train = $("#train").val();
            var job_intention = $("#job_intention").val();

            var additional = $("#additional").val();
            var it = $("#it").val();
            var experience = $("#experience").val();

            $.get("${pageContext.request.contextPath}/resume/saveResume",
                {sex:sex,birthday:birthday,college:college,s_native:s_native,idcard:idcard,salary:salary,address:address,major:major,internship:internship,education:education,train:train,job_intention:job_intention,additional:additional,it:it,experience:experience},
                function (data) {
                    if(data==true){
                        alert("添加成功")
                        window.open("${pageContext.request.contextPath}/resume/myResume")
                    }else {
                        alert("添加失败")
...
<div class="div1Intro">
    ...
    <div class="div12Intro">
            ...
            <table class="table1Intro" cellspacing="5px;">
                <tr>
                    ...
                    <td style="width:250px">
                        <input type="radio" checked="checked" name="sex" value="男" class="sex"/>男
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" style="width:250px;" id="major"/>
                    </td>
                    <td>
        ...
        <div class="tablediv2Intro">
            <table class="table2Intro" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        <textarea class="textarea1Intro" style="resize:none" id="internship"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea id="education" class="textarea1Intro" style="resize:none"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea class="textarea1Intro" style="resize:none" id="train"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea id="job_intention" class="textarea1Intro" style="resize:none"></textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="tablediv3Intro">
            <table class="table3Intro" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <textarea class="textarea1Intro" style="resize:none" id="additional"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea class="textarea1Intro" style="resize:none" id="it"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea class="textarea1Intro" style="resize:none" id="experience"></textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="text-align:center">
            <input type="button" id="btnIntro" style="color: #00abd8;width: 100px;height: 40px" onclick="sub()" value="保存">
        </div>
    </div>
    <!--中间内容右边结束-->
</div>
