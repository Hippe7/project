...
<div class="div1Intro">
    ...
    <div class="div11Intro">
        ...
        <div id="pop0" class="div111Intro"><img src="../images/register-arrow.gif" /><a><span class="span11InnerIntro">他的简历</span></a></div>
    ...
    <div class="div12Intro">
        <div class="div111Intro"><img src="../images/register-arrow.gif" /><span class="span11InnerIntro"><a name="point1">基本个人信息</a></span></div>
            ...
            <table class="table1Intro" cellspacing="5px;">
                <tr>
                    ...
                    <td style="width:280px;">
                        ${sessionScope.student1.stu_name}
                    </td>
                    <td style="width:80px">
                        <span class="star1Intro">*</span>性别
                    </td>
                    <td style="width:250px">
                        ${sessionScope.resume1.sex}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ${sessionScope.resume1.birthday}
                    </td>
                    <td>
                        <span class="star1Intro">*</span>学院名称
                    </td>
                    <td>
                        ${sessionScope.resume1.college}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ${sessionScope.resume1.s_native}
                    </td>
                    <td>
                        <span class="star1Intro">*</span>身份证号
                    </td>
                    <td>
                        ${sessionScope.resume1.idcard}
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <div class="div111Intro"><img src="../images/register-arrow.gif" /><span class="span11InnerIntro"><a name="point2">他的简历</a></span></div>
        <img src="../images/border.JPG" class="img2Intro" />
        <div class="tablediv2Intro">
            <table class="table2Intro" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td>
                        ${sessionScope.resume1.internship}
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ${sessionScope.resume1.education}
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ${sessionScope.resume1.job_intention}
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="tablediv3Intro">
            <table class="table3Intro" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        ${sessionScope.resume1.additional}
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ${sessionScope.resume1.experience}
                    </td>
                </tr>
            </table>
        </div>
