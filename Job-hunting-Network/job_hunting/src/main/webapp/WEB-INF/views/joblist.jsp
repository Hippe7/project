...
<div class="soubg">
    <div class="sou">
        ...
        <span class="fr">
            ...
            <c:if test="${user!=null}" >
                <span class="fl">你好，<a href="${pageContext.request.contextPath}/user/findSelf">${sessionScope.user}</a>&nbsp; <a href="${pageContext.request.contextPath}/user/findSutRegist.action">毕业生注册</a>&nbsp;|&nbsp;<a href="intro.html">我的简历</a>&nbsp;|</span>
            </c:if>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<table class="list_name">
    <tr>
    <td class="list_name1">职位名称</td>
    <td class="list_name1">面向学院</td>
    <td class="list_name1">工作地点</td>
    <td class="list_name1">薪资</td>
    <td class="list_name1">发布时间</td>
    </tr>
</table>

<c:set var="key"  value = "${sessionScope.key}"></c:set>
<c:if test="${key==null}">
<table class="list_name">
    <tr>
        <td class="list_name1">无</td>
        <td class="list_name1">无</td>
        <td class="list_name1">无</td>
        <td class="list_name1">无</td>
        <td class="list_name1">无</td>
...
<c:if test="${key!=null}" >
<c:forEach items="${sessionScope.key}" var="key" varStatus="status">
    <table class="list_name">
    <tr>
        <td class="list_name1"><a href="${pageContext.request.contextPath}/job/jobDetails?id=${key.id}"><span>${key.job_name}</span></a></td>
        <td class="list_name1">${key.college}</td>
        <td class="list_name1">${key.job_address}</td>
        <td class="list_name2">${key.salary}</td>
        <td class="list_name1"><fmt:formatDate value="${key.date}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
    </tr>
    </table>
</c:forEach>
</c:if>
