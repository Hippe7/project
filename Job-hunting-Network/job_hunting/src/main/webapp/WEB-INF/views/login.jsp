                ...
                <div class="container">
                    ...
                    <div class="css-conbox">
                        ...
                        <div class="css-main">
                            <form id="form"  method="post" onsubmit="return check()">
                                <div class="css-input-group">
                                    <div class="css-input-group">
                                        ...
                                        <div class="css-group">
                                            <input placeholder="请输入帐号" name="loginName" id="id" type="text">
                                        </div>
                                    </div>
                                    <div class="css-input-group">
                                        <div class="css-tit">密码</div>
                                        <div class="css-group">
                                            <input placeholder="请输入密码" name="password" id="pwd" type="password">
                                        </div>
                                    </div>
                            ...
                            <div>
                                <span id="span2">没有账号？</span>
                                <input type="button" value="毕业生注册" class="btn" onclick="window.open('findSutRegist.action')"  />
                                <input type="button" value="企业注册" class="btn" onclick="window.open('findEntRegist.action')"  />
                            </div>
...
<script>
    ...
    function check(){
        ...
        switch(ch) {
            case "1" : $(form).attr("action","${pageContext.request.contextPath}/student/login1.action");break;
            case "2" : $(form).attr("action","${pageContext.request.contextPath}/enterprise/login2.action");break;
            case "3" : $(form).attr("action","${pageContext.request.contextPath}/admin/login3.action");break;
        }
        return true;
    }
</script>
